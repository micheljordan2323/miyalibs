...
key=[("cnt","int"),("time","text"),("co2","real"),("humid","real"),("temp","real")]
...
while pi.state != "quit":
    if pi.state == "init":
        ...
        print("*** measure ***")
        str_co2,str_rh,str_temp=co2.measure()

        print(float("%f"%str_co2))
        co22=float("%f"%str_co2)

        print(float("%f"%str_rh))
        rh=float("%f"%str_rh)

        print(float("%f"%str_temp))
        temp=float("%f"%str_temp)
